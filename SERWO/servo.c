...
void Servo_Init(unsigned int uiServoFrequency){Led_Init();
  DetectorInit();
Timer1Interrupts_Init(uiServoFrequency,&Automat);}

void Servo_Callib(void){sServo.eState=CALLIB;}

void Servo_GoTo(unsigned int uiPosition){sServo.uiDesiredPosition=uiPosition;}
